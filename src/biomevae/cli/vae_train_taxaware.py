...
def build_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser("biomevae-train-tax")
...
def _run_optuna(
    ...
    def objective(trial):
        ...
        # Demote posterior-collapsed trials so Optuna cannot pick degenerate
        # hyperparameters whose val_recon is low only because the encoder
        # ignored the input.
